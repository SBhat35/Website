...
const about = () => {
  return (
    ...
    <main className={styles.main}>
        ...
        the 'a' is pronounced 'uh' and the 't' is pronounced 'th' (S-uh-chith). It's not entirely intuitive, but follows the same pattern as many other East Asian/Indian names. I have been recently been going by Sach (pronounced 'Such').
</h3>
